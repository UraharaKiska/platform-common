...
//go:generate minimock -i github.com/UraharaKiska/platform-common/pkg/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mock
...
import (
	...
	mm_db "github.com/UraharaKiska/platform-common/pkg/db"
